...
class Admin_Menu{
	...
	function admin_menu(){
		add_submenu_page( 'serial-numbers', __( 'Add generator rule', 'wc-serial-number-pro' ), __( 'Add generator rule', 'wc-serial-number-pro' ), 'manage_woocommerce', 'add-wc-generator-rule', array(
