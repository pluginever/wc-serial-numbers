...
class Admin_Menu{
	...
	function admin_menu() {
		...
		add_submenu_page( 'woocommerce', __( 'Generate Serial Numbers', 'wc-serial-numbers' ), __( 'Generate Serial Numbers', 'wc-serial-numbers' ), 'manage_woocommerce', 'generate-serial-numbers', array(
