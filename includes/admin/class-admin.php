...
class WCSN_Admin {
	...
	*/
	...
	public function define_constants() {
		define( 'WCSN_ADMIN_ABSPATH', dirname( __FILE__ ) );
	}
	...
	public function includes() {
		require_once( WCSN_ADMIN_ABSPATH . '/class-admin-menu.php' );
		require_once( WCSN_ADMIN_ABSPATH . '/class-settings-api.php' );
		require_once( WCSN_ADMIN_ABSPATH . '/class-settings.php' );
		require_once( WCSN_ADMIN_ABSPATH . '/class-metabox.php' );
		require_once( WCSN_ADMIN_ABSPATH . '/class-admin-notice.php' );
		require_once( WCSN_ADMIN_ABSPATH . '/actions-functions.php' );
	}
