...
class Serial_List_Table extends \WP_List_Table
{
	...
	private function table_data()
	{
		$data   = array();
		$data[] = array(
			'serial_numbers' => 'sl-my-0123',
			'usage_limit'    => '0/5',
			'expires_on'     => '2019-04-20 12:13:44',
			'product'        => 'Sample Product',
			'order'          => '#1',
			'purchased_on'   => '2019-04-20 12:13:44'
		);
		$data[] = array(
			'serial_numbers' => 'sl-my-0121',
			'usage_limit'    => '0/5',
			'expires_on'     => '2019-04-20 12:13:44',
			'product'        => 'Sample Product',
			'order'          => '#1',
