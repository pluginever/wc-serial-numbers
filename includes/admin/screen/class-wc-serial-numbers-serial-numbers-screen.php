			...
			<form method="post" action="<?php echo esc_html( admin_url( 'admin-post.php' ) ); ?>" style="max-width: 600px">
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<select name="product_id" id="product_id" class="regular-text wc-serial-numbers-select-product" required="required" placeholder="<?php _e( 'Select Product', 'wc-serial-numbers' ); ?>">
