 ...
 * @return bool
 */
function wc_serial_numbers_validate_checkout() {
...
add_action( 'woocommerce_check_cart_items', 'wc_serial_numbers_validate_checkout' );

function wc_serial_numbers_order_processed( $order_id ) {
...
add_action( 'woocommerce_checkout_order_processed', 'wc_serial_numbers_order_processed' );
add_action( 'woocommerce_update_order', 'wc_serial_numbers_order_processed' );
