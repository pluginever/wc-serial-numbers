...
//        add_filter( 'cron_schedules', array( __CLASS__, 'cron_schedules' ) );
    ...
    public static function create_options() {
        ...
        //save install date
        update_option( 'wc_serial_numberss_install_date', current_time( 'timestamp' ) );
    }
    ...
    private static function create_roles() {
        ...
        add_role(
            'userrole',
            __( 'User Role', 'wc-serial-numbers' ),
    ...
    public static function cron_schedules( $schedules ) {
        $schedules['monthly'] = array(
            'interval' => 2635200,
            'display'  => __( 'Monthly', 'wc-serial-numbers' ),
        );
    ...
    private static function create_cron_jobs() {
        wp_clear_scheduled_hook( 'wc_serial_numbers_daily_cron' );
        wp_schedule_event( time(), 'daily', 'wc_serial_numbers_daily_cron' );
    }
