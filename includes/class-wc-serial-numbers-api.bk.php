...
class WC_Serial_Numbers_API {
	...
	public function __construct() {
		error_log('WC_Serial_Numbers_API');
		add_action( 'woocommerce_api_serial-numbers-api', array( __CLASS__, 'handle_api_request' ) );
		add_action( 'wc_serial_numbers_api_action_check', array( __CLASS__, 'check_license' ) );
		add_action( 'wc_serial_numbers_api_action_activate', array( __CLASS__, 'activate_license' ) );
		add_action( 'wc_serial_numbers_api_action_deactivate', array( __CLASS__, 'deactivate_license' ) );
		add_action( 'wc_serial_numbers_api_action_version_check', array( __CLASS__, 'version_check' ) );
