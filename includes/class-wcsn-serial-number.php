 ...
 */
class WCSN_Serial_Number {
	/**
	 * WCSN_Serial_Number constructor.
	 */
	public function __construct() {
		//todo filter duplicate serial number
	}

	/**
	 * Returns all available types of serial numbers
	 *
	 * @return array
	 * @since 1.1.5
	 */
	public static function statuses() {
		return apply_filters( 'wcsn_serial_number_statuses',
			array(
	...
	public static function insert( $args ) {
		...
		$allow_duplicate = apply_filters( 'wcsn_allow_duplicate_serial_number', true );
	...
	public static function update_status($id, $status){
		...
		if ( empty( $status ) || ! in_array( $status, array_keys( self::statuses() ) ) ) {
			return false;
		}
	 ...
	 */
	public static function wcsn_encrypt_serial_number( $key ) {
	 ...
	 * @return string|WP_Error
	 */
	public static function wcsn_decrypt_serial_number( $key ) {
		$p_key      = wcsn_get_encrypt_key();
		$encryption = WCSN_Encryption::instance();
		try {
