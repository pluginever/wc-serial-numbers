...
== Changelog ==
= 2.4.0 (10th June 2026) =
* Enhance: Migrated the plugin to the new B8 framework for better performance and maintainability.
* Enhance: The minimum required WordPress version is now 6.4.
* Fix: PHP deprecation notice when the plugin updater runs on a fresh installation.
