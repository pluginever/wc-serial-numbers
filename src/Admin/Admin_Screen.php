<?php
namespace PluginEver\WC_Serial_Numbers\Admin;

use PluginEver\WC_Serial_Numbers\Query;
...
class Admin_Screen {
	...
	public static function render_add( $action ) {
		...
		if ( ! empty( $id ) && $serial = Query::init()->from( 'serial_numbers' )->find( $id ) ) {
			$update             = true;
	...
	public static function render_table() {
		$table    = new Serial_Numbers_List_Table();
