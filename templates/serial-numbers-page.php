<?php if ( ! isset( $_REQUEST['action'] ) && $_REQUEST['action'] != 'edit' ) { ?><?php include WPWSN_INCLUDES . '/admin/class-serial-list-table.php' ?>
	...
	<div class="wrap">
		...
		echo '<form id="serial-numbers-filter" method="get">';
		$serial_list->display();
		echo '</form>';
		?>
	</div>
