...
final class WCSerialNumbers {
	...
	public function plugin_action_links( $links ) {
		$links[] = '<a href="https://www.pluginever.com/docs/wocommerce-serial-numbers/">' . __( 'Documentation', 'wc-serial-numbers' ) . '</a>';
	...
	private function define_constants() {
		...
		define( 'WC_SERIAL_NUMBERS_SCREEN', WC_SERIAL_NUMBERS_PATH . '/screen' );
	}
...
//		require_once( WC_SERIAL_NUMBERS_INCLUDES . '/class-menu.php' );
